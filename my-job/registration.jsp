...
<body>
	<form action='Register' method="post" id="regform">
		...
		<p><label for="fname">FIRST NAME</label> <input type="text" name="firstName" id="fname" required/></p>
		<p><label for="lname">LAST NAME</label> <input type="text" name="lastName" id="lname" required/></p>
		<p><label for="usnm">Username</label> <input type="text" name="username" id="usnm" required/></p>
		<p><label for="dob">DOB</label> <input type="text" name="dob" id="dob" required/></p>
		<p><label for="phoneNo">Phone Number</label> <input type="tel" name="phoneNo" id="phoneNo" required/></p>
